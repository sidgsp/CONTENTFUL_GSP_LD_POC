    ...
    <div className="footer-main">
      ...
      <div className="footer-content">
        ...
        <div className="footer-links">
          ...
          <div style={{'display': 'block'}}>
            <ul>
              <li><a className="ld-sg-link" href="https://blog.londondrugs.com/pharmacy-services-and-information" data-category="Footer OurServices" data-action="Learn More" data-label="Prescription Refills" target="_blank">Prescription Refills</a></li>
              <li><a className="ld-sg-link" href="https://pharmacy.londondrugs.com/manage-prescriptions/delivery-and-pickup" data-category="Footer OurServices" data-action="Learn More" data-label="Prescription Delivery" target="_blank">Prescription Delivery</a></li>
              ...
              <li><a className="ld-sg-link" href="http://www.ldinsurance.ca/" data-category="Footer OurServices" data-action="Learn More" data-label="Insurance Services" target="_blank">Insurance Services</a></li>
              ...
              <li><a className="ld-sg-link" href="https://pharmacy.londondrugs.com/health-clinics/travel-clinic" data-category="Footer OurServices" data-action="Learn More" data-label="Travel Clinics" target="_blank">Travel Clinics</a></li>
              ...
              <li><a title="IT Business Solutions" className="ld-sg-link" href="https://www.tld.com/" data-category="Footer OurServices" data-action="Learn More" data-label="TLD Computers" target="_blank">TLD Computers</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="footer-links">
          ...
          <div style={{'display': 'block'}}>
            <ul> 
              <li><a className="ld-sg-link" href="https://www.londondrugs.com/on/demandware.static/-/Library-Sites-LondonDrugs-content-Library/default/dw7dd49aae/pdf/notices/London%20Drugs%20Corporate%20Public%20Health%20and%20Safety%20Measures.pdf" target="_blank">COVID-19 Safety Measures</a></li>
        ...
        <div className="social-links">
          <h4 className="ld-sg-heading" style={{'marginTop':'.25rem'}}>Connect With Us</h4>
            <ul>
              <li><a className="facebook" href="http://www.facebook.com/LondonDrugs" title="facebook" target="_blank">facebook</a></li>
              <li><a className="twitter" href="http://twitter.com/LondonDrugs/" title="X (twitter)" target="_blank" >X (twitter)</a></li>
              <li><a className="pinterest" href="https://www.pinterest.ca/londondrugs/" title="pinterest" target="_blank">pinterest</a></li>
              <li><a className="instagram" title="instagram" target="_blank">instagram</a></li>
              <li><a className="youtube" href="https://www.youtube.com/user/LondonDrugsLtd" title="youtube" target="_blank">youtube</a></li>
