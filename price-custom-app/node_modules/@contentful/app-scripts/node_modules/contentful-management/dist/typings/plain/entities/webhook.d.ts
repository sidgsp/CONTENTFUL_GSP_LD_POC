...
import { CollectionProp, GetSpaceParams, GetWebhookCallDetailsUrl, GetWebhookParams, QueryParams } from '../../common-types';
import { CreateWebhooksProps, UpsertWebhookSigningSecretPayload, WebhookCallDetailsProps, WebhookCallOverviewProps, WebhookHealthProps, WebhookProps, WebhookSigningSecretProps } from '../../entities/webhook';
...
export type WebhookPlainClientAPI = {
     ...
     * ```
     */
    upsertSigningSecret(params: OptionalDefaults<GetSpaceParams>, rawData: UpsertWebhookSigningSecretPayload): Promise<WebhookSigningSecretProps>;
    /**
     * Creates the Webhook
